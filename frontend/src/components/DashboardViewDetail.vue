<template>
    ...
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Boolean label="UploadStaus" v-model="item.uploadStaus" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Boolean label="IndexStatus" v-model="item.indexStatus" :editMode="editMode" @change="change" />
            </div>
            <div>
